...
// Decrypt sensitive PHI fields only if they exist
if (in_array($viewMode, ['facility', 'carrier_awarded'])) {
    $phi['first_name'] = !empty($trip['patient_first_name_encrypted']) ? $encryption->decrypt($trip['patient_first_name_encrypted']) : '';
    $phi['last_name'] = !empty($trip['patient_last_name_encrypted']) ? $encryption->decrypt($trip['patient_last_name_encrypted']) : '';
    $decrypted_dob = !empty($trip['patient_dob_encrypted']) ? $encryption->decrypt($trip['patient_dob_encrypted']) : null;
    $phi['ssn_last4'] = !empty($trip['patient_ssn_last4_encrypted']) ? $encryption->decrypt($trip['patient_ssn_last4_encrypted']) : '';
