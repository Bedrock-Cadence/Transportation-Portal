...
// Check if PHI data exists. The LEFT JOIN in getTripByUuid will result in NULL for these 
// fields if the trips_phi row has been deleted for a completed trip.
if (isset($trip['patient_first_name_encrypted'])) {
    // PHI exists, so we decrypt it based on view mode.
    ...
    // Common fields for all authorized viewers
    ...
    // PHI has been purged. Set default values for display.
    $phi = [
        'first_name' => '[PHI',
        'last_name' => 'Purged]',
        'dob_formatted' => '[Purged]',
        'ssn_last4' => '[Purged]',
        'diagnosis' => 'Not Available',
        'equipment' => 'Not Available',
        'isolation' => 'Not Available',
        'height_formatted' => 'N/A',
        'weight_lbs' => 'N/A'
    ];
}
// --- END OF MODIFICATION ---
...
<div class="bg-white shadow-md rounded-lg overflow-hidden border border-gray-200 max-w-4xl mx-auto">
    <div class="px-6 py-4 bg-gray-50 border-b border-gray-200 flex justify-between items-center">
        <div>
            ...
            <p class="text-sm text-gray-500 font-mono">Trip #: <?= Utils::e($trip['sid']); ?></p>
        </div>
            ...
            <div class="space-y-6">
                ...
                <dl class="space-y-4">
                    <div>
                        ...
                        <dd class="mt-1 text-base text-gray-900"><?= Utils::e($trip['origin_street']); ?>, <?= Utils::e($trip['origin_city']); ?>, <?= Utils::e($trip['origin_state']); ?> <?= Utils::e($trip['origin_zip']); ?></dd>
                    </div>
                    <div>
